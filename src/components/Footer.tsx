...
const Footer: React.FC = () => {
  ...
  return <footer className="py-12 bg-wellness-darkGreen text-white relative overflow-hidden">
      <div className="container mx-auto px-[60px]">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-wellness-softBeige/20">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button onClick={scrollToTop} size="sm" variant="outline" className="p-2 rounded-full hover:bg-wellness-softGreen/20 border-wellness-softGreen">
