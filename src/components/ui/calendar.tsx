  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center bg-[#ea384c] text-white p-2 rounded-t-lg",
        caption_label: "text-sm font-medium",
        nav: "space-x-1 flex items-center",
        nav_button: cn(
          buttonVariants({ variant: "outline" }),
          "h-7 w-7 bg-transparent p-0 text-white opacity-75 hover:opacity-100 hover:bg-white/10"
        ),
        ...
        head_cell: cn(
          ...
          "first:text-[#ea384c]" // Sunday in red
        ),
        ...
        day_today: highlightToday ? "bg-accent text-accent-foreground font-semibold border-[#ea384c] border" : "",
