    ...
    <div className="w-full flex flex-col items-center">
      {isConversationActive ? (
        ...
        <div className="flex flex-col items-center py-6 px-4">
          ...
          <p className="text-wellness-charcoal mb-5 text-center max-w-md">
            Start a voice conversation with an AI therapist to discuss your feelings, thoughts, or concerns in a safe, private space.
          </p>
          <Button 
