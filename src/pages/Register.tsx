              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`block w-full pl-10 pr-3 py-2 border ${emailError ? 'border-red-400' : 'border-wellness-softGreen/40'} rounded-lg bg-white/50 focus:outline-none focus:ring-2 focus:ring-wellness-mediumGreen text-wellness-darkGreen placeholder-wellness-charcoal/50`} 
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    ...
                    className={`block w-full pl-10 pr-10 py-2 border ${passwordError ? 'border-red-400' : 'border-wellness-softGreen/40'} rounded-lg bg-white/50 focus:outline-none focus:ring-2 focus:ring-wellness-mediumGreen text-wellness-darkGreen placeholder-wellness-charcoal/50`} 
                    placeholder="••••••••" 
                    required 
                    minLength={8} 
                  />
