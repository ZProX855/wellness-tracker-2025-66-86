...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-wellness-dark">
      <Header />
      ...
      <main className="pt-24 pb-16">
        ...
        >
          <div className="max-w-6xl mx-auto w-full">
            <div className="text-center mb-20">
              ...
              <h1 
                className="text-5xl sm:text-6xl lg:text-7xl font-medium tracking-tight text-wellness-darkGreen mb-6 leading-tight"
                style={{ 
              ...
              <p 
                className="text-xl sm:text-2xl text-wellness-charcoal/80 max-w-3xl mx-auto mb-12 leading-relaxed"
                style={{ 
            ...
            >
              <div className="w-8 h-12 rounded-full border-2 border-wellness-darkGreen/30 flex justify-center items-start p-1">
                <div className="w-1 h-3 bg-wellness-darkGreen/40 rounded-full animate-pulse-soft"></div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-wellness-charcoal/70 max-w-2xl mx-auto opacity-0 animate-fade-in" style={{ animationDelay: '200ms' }}>
                Our suite of intelligent wellness tools helps you make informed decisions about your health.
              </p>
            </div>
            
            <div className="mb-10 flex justify-center gap-4 opacity-0 animate-fade-in" style={{ animationDelay: '300ms' }}>
              ...
              {categories[activeCategory].tools.map((tool, idx) => (
                ...
                >
                  <button 
                    ...
                    className="w-full h-full glass-panel hover:scale-[1.02] active:scale-[0.98] transition-all duration-500 ease-out-expo p-8 flex flex-col items-center text-center group"
                  >
        ...
        <section className="py-28 px-4 sm:px-6 text-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto relative z-10 opacity-0 animate-fade-in" style={{ animationDelay: '400ms' }}>
      ...
      <footer className="bg-white py-12 border-t border-wellness-softGreen/30">
